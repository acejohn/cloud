                        ...
                        data: {},
                         success: function (data) {
                             ...
                             $.each(t, function (marker, t) {
                                 ...
                                 var DevStatus = t.IsOnline;

                                 console.log(DevStatus)

                                 if (DevStatus == true) {
                                     var blink = '<i class="fa fa-circle active Blink-mapStat"></i><span style="margin-left: 6px;">Online</span> <hr>';
                                 } else {
                                     var blink = '<i class="fa fa-circle inactive" style="color: #9E9E9E"></i><span style="color:#9E9E9E;margin-left: 6px;">Offline</span><hr>';
                                 }
